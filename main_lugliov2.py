# dentro la funzione livella macchine c'è una correzione per Tacchella 2 (non essendo preferita di nessuno va inizializzato il suo tempo disponibile)
# per visualizzare i volumi annuali vengono esclusi gli esplosi in figure tramite le ultime 2 lettere AA-AP-SA-SP -V -O
# i filtri sono caricati dal file statico
import pandas as pd
...
filtri = pd.read_excel(flat_path, sheet_name='filtri')
